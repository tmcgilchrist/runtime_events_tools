module M : Gc_stats_intf.S = struct
  ...
  (* OCaml 5.5+ (ocaml/ocaml#14189) emits the new word-sized counters
     alongside the legacy bytes counters. Only consume the [_WORDS] events
     here, otherwise minor/promoted totals would be double-counted. *)
